...
static const char *fonts[] = { "Maple Mono:size=11:antialias=true:autohint=true" };
...
static const int refreshrate = 60;  /* refresh rate (per second) for client move/resize, set it to your monitor refresh rate or double of that*/
...
static const Key keys[] = {
	...
	{ MODKEY|ShiftMask,             XK_s,      focusstack,     {.i = +1 } },
	{ MODKEY,                       XK_z,      focusstack,     {.i = -1 } },
	{ MODKEY,                       XK_i,      incnmaster,     {.i = +1 } },
	{ MODKEY,                       XK_k,      incnmaster,     {.i = -1 } },
	{ MODKEY,                       XK_h,      setmfact,       {.f = -0.05} },
	{ MODKEY,                       XK_l,      setmfact,       {.f = +0.05} },
	{ MODKEY|ShiftMask,             XK_p,      swapmaster,     {0} },
	{ MODKEY,                       XK_v,      view,           {0} },
	...
	{ MODKEY|ShiftMask,             XK_g,      togglefloating, {0} }, //default toggle floating bind.
